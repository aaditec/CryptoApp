...
import com.NITV.cryptoapp.di.AppModule_ProvideCoinApiFactory;
import com.NITV.cryptoapp.di.AppModule_ProvideCoinRepositoryFactory;
...
import com.NITV.cryptoapp.presentations.UI.MainActivity;
import com.NITV.cryptoapp.presentations.coin_details.CoinDetailsViewModel;
import com.NITV.cryptoapp.presentations.coin_details.CoinDetailsViewModel_HiltModules_KeyModule_ProvideFactory;
import com.NITV.cryptoapp.presentations.coin_list.CoinListViewModel;
import com.NITV.cryptoapp.presentations.coin_list.CoinListViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC extends MyApplication_HiltComponents.SingletonC {
  ...
  private volatile Object coinAPI = new MemoizedSentinel();

  private volatile Object coinRepository = new MemoizedSentinel();
  ...
  private CoinAPI coinAPI() {
    Object local = coinAPI;
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = coinAPI;
        if (local instanceof MemoizedSentinel) {
          local = AppModule_ProvideCoinApiFactory.provideCoinApi();
          coinAPI = DoubleCheck.reentrantCheck(coinAPI, local);
        }
      }
    }
    return (CoinAPI) local;
  }

  private CoinRepository coinRepository() {
    Object local = coinRepository;
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = coinRepository;
        if (local instanceof MemoizedSentinel) {
          local = AppModule_ProvideCoinRepositoryFactory.provideCoinRepository(coinAPI());
          coinRepository = DoubleCheck.reentrantCheck(coinRepository, local);
        }
      }
    }
    return (CoinRepository) local;
  }
  ...
  private static final class ActivityRetainedCImpl extends MyApplication_HiltComponents.ActivityRetainedC {
    ...
    private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
      ...
      private volatile Provider<CoinDetailsViewModel> coinDetailsViewModelProvider;

      private volatile Provider<CoinListViewModel> coinListViewModelProvider;
      ...
      private GetCoinUseCase getCoinUseCase() {
        return new GetCoinUseCase(singletonC.coinRepository());
      }
      ...
      private Provider<CoinDetailsViewModel> coinDetailsViewModelProvider() {
        Object local = coinDetailsViewModelProvider;
        if (local == null) {
          local = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 0);
          coinDetailsViewModelProvider = (Provider<CoinDetailsViewModel>) local;
        }
        return (Provider<CoinDetailsViewModel>) local;
      }

      private GetCoinsUseCase getCoinsUseCase() {
        return new GetCoinsUseCase(singletonC.coinRepository());
      }
      ...
      private Provider<CoinListViewModel> coinListViewModelProvider() {
        Object local = coinListViewModelProvider;
        if (local == null) {
          local = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 1);
          coinListViewModelProvider = (Provider<CoinListViewModel>) local;
        }
        return (Provider<CoinListViewModel>) local;
      }

      @Override
      public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
        return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(2).put("com.NITV.cryptoapp.presentations.coin_details.CoinDetailsViewModel", (Provider) coinDetailsViewModelProvider()).put("com.NITV.cryptoapp.presentations.coin_list.CoinListViewModel", (Provider) coinListViewModelProvider()).build();
      }
      ...
      private static final class SwitchingProvider<T> implements Provider<T> {
        ...
        public T get() {
          switch (id) {
            case 0: // com.NITV.cryptoapp.presentations.coin_details.CoinDetailsViewModel 
            return (T) viewModelCImpl.coinDetailsViewModel();

            case 1: // com.NITV.cryptoapp.presentations.coin_list.CoinListViewModel 
            return (T) viewModelCImpl.coinListViewModel();
